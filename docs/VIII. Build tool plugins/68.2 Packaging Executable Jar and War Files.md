...
```
**注** 具体参考[87.1 创建可部署的war文件](https://docs.spring.io/spring-boot/docs/2.0.0.RELEASE/reference/htmlsingle/#howto-create-a-deployable-war-file)章节。 

高级配置选项和示例可在[插件信息页面](https://docs.spring.io/spring-boot/docs/2.0.0.RELEASE/maven-plugin)获取。
